<template>
  <div class="login-view">
    ...
    <form method="get" @submit.prevent="onsubmit()">
      ...
      <div class="form-pwd">
        <label>
          ...
          <template v-if="passType === 'password'">
            <input v-model="token" type="password" name="token" @input="updateData" placeholder="密码">
          </template>
          <template v-if="passType === 'text'">
            <input v-model="token" type="text"  name="token" @input="updateData" placeholder="密码">
          </template>
      ...
      <div class="">
        <button class="submit" @click="onSubmit" type="submit" :disabled="isDisabled" :class="{disabled: isDisabled}">
          {{loginState}}
        </button>
      </div>
    </form>
